...
```bash
git clone https://github.com/wasted-03/instagram-mern.git
cd instagram-mern
```
### 2️⃣ Setup Backend
```bash
...
**Image Storage**
- 📷 Branch [dev-v3-cloudinary](https://github.com/wasted-03/instagram-mern/tree/dev-v3-cloudinary): Utilizes Cloudinary for Image Storage
...
[![github](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/wasted-03)
